...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import12.viewFactory_Nav0(this.viewUtils, this.injector(2), this._appEl_2);
        this._Nav_2_4 = new import11.Nav(this.parentInjector.get(import13.ViewController, null), this.parentInjector.get(import14.NavControllerBase, null), this.parentInjector.get(import15.App), this.parentInjector.get(import16.Config), this.parentInjector.get(import17.Keyboard), new import18.ElementRef(this._el_2), this.parentInjector.get(import19.NgZone), this.renderer, this.parentInjector.get(import20.ComponentFactoryResolver), this.parentInjector.get(import21.GestureController), this.parentInjector.get(import22.TransitionController), this.parentInjector.get(import23.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import11.Nav) && (2 === requestNodeIndex))) {
