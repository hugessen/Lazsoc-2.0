...
class _View_MyApp0 extends import1.AppView<import3.MyApp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_2 = this.renderer.createElement(parentRenderNode,'ion-nav',(null as any));
    this.renderer.setElementAttribute(this._el_2,'swipeBackEnabled','false');
    this._appEl_2 = new import2.AppElement(2,(null as any),this,this._el_2);
    var compView_2:any = import12.viewFactory_Nav0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Nav_2_4 = new import11.Nav(this.parentInjector.get(import13.ViewController,(null as any)),this.parentInjector.get(import14.NavControllerBase,(null as any)),this.parentInjector.get(import15.App),this.parentInjector.get(import16.Config),this.parentInjector.get(import17.Keyboard),new import18.ElementRef(this._el_2),this.parentInjector.get(import19.NgZone),this.renderer,this.parentInjector.get(import20.ComponentFactoryResolver),this.parentInjector.get(import21.GestureController),this.parentInjector.get(import22.TransitionController),this.parentInjector.get(import23.DeepLinker,(null as any)));
    this._appEl_2.initComponent(this._Nav_2_4,[],compView_2);
    compView_2.create(this._Nav_2_4,[],(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import11.Nav) && (2 === requestNodeIndex))) { return this._Nav_2_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this._Nav_2_4.swipeBackEnabled = currVal_1;
...
export function viewFactory_MyApp0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MyApp> {
  if ((renderType_MyApp === (null as any))) { (renderType_MyApp = viewUtils.createRenderComponentType('C:/Users/Richard Hugessen/Documents/GitHub/Lazsoc-2.0/.tmp/app/app.html',0,import9.ViewEncapsulation.None,styles_MyApp,{})); }
