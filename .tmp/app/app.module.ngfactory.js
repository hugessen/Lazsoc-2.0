...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_29", {
        get: function () {
            if ((this.__APP_ID_29 == null)) {
                (this.__APP_ID_29 = import70._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_33", {
        get: function () {
            if ((this.__EventManager_33 == null)) {
                (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32, this.parent.get(import74.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_37", {
        get: function () {
            if ((this.__RootRenderer_37 == null)) {
                (this.__RootRenderer_37 = import75._createConditionalRootRenderer(this._DomRootRenderer_36, this.parent.get(import75.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AppRootToken_53", {
        get: function () {
            if ((this.__AppRootToken_53 == null)) {
                (this.__AppRootToken_53 = import76.MyApp);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Keyboard_61", {
        get: function () {
            if ((this.__Keyboard_61 == null)) {
                (this.__Keyboard_61 = new import34.Keyboard(this._Config_21, this._Form_58, this.parent.get(import74.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_63", {
        get: function () {
            if ((this.__LocationStrategy_63 == null)) {
                (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import77.PlatformLocation), this.parent.get(import78.APP_BASE_HREF, null), this._Config_21));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TapClick_69", {
        get: function () {
            if ((this.__TapClick_69 == null)) {
                (this.__TapClick_69 = new import41.TapClick(this._Config_21, this._App_22, this.parent.get(import74.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_UrlSerializer_73", {
        get: function () {
            if ((this.__UrlSerializer_73 == null)) {
                (this.__UrlSerializer_73 = import79.setupUrlSerializer(this._DeepLinkConfigToken_54));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_DeepLinker_74", {
        get: function () {
            if ((this.__DeepLinker_74 == null)) {
                (this.__DeepLinker_74 = import80.setupDeepLinker(this._App_22, this._UrlSerializer_73, this._Location_64));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_CacheService_76", {
        get: function () {
            if ((this.__CacheService_76 == null)) {
                (this.__CacheService_76 = new import46.CacheService(this._Events_57, this._Http_50, this._Storage_75));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocalStorage_77", {
        get: function () {
            if ((this.__LocalStorage_77 == null)) {
                (this.__LocalStorage_77 = new import47.LocalStorage(this._Storage_75));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocalData_78", {
        get: function () {
            if ((this.__LocalData_78 == null)) {
                (this.__LocalData_78 = new import48.LocalData(this._CacheService_76, this._LocalStorage_77));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Calendar_79", {
        get: function () {
            if ((this.__Calendar_79 == null)) {
                (this.__Calendar_79 = new import49.Calendar());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Network_80", {
        get: function () {
            if ((this.__Network_80 == null)) {
                (this.__Network_80 = new import50.Network());
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import74.NgZone), this.parent.get(import87.Console), this, this._ErrorHandler_11, this, this._ApplicationInitStatus_24, this.parent.get(import12.TestabilityRegistry, null), this._Testability_25);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import89.ErrorHandler)) {
            return this._ErrorHandler_11;
        }
        if ((token === import84.ConfigToken)) {
            return this._ConfigToken_12;
        }
        if ((token === import81.UrlToken)) {
            return this._UrlToken_13;
        }
        if ((token === import81.QueryParams)) {
            return this._QueryParams_14;
        }
        if ((token === import82.PlatformConfigToken)) {
            return this._PlatformConfigToken_15;
        }
        if ((token === import83.UserAgentToken)) {
            return this._UserAgentToken_16;
        }
        if ((token === import83.NavigatorPlatformToken)) {
            return this._NavigatorPlatformToken_17;
        }
        if ((token === import83.DocumentDirToken)) {
            return this._DocumentDirToken_18;
        }
        if ((token === import83.DocLangToken)) {
            return this._DocLangToken_19;
        }
        if ((token === import83.Platform)) {
            return this._Platform_20;
        }
        if ((token === import84.Config)) {
        ...
        if ((token === import70.APP_ID)) {
            return this._APP_ID_29;
        }
        if ((token === import90.DOCUMENT)) {
            return this._DOCUMENT_30;
        }
        if ((token === import73.HAMMER_GESTURE_CONFIG)) {
        ...
        if ((token === import96.XSRFStrategy)) {
        ...
        if ((token === import98.AppRootToken)) {
            return this._AppRootToken_53;
        }
        if ((token === import79.DeepLinkConfigToken)) {
        ...
        if ((token === import78.LocationStrategy)) {
        ...
        if ((token === import79.UrlSerializer)) {
            return this._UrlSerializer_73;
        }
        if ((token === import80.DeepLinker)) {
            return this._DeepLinker_74;
        }
        if ((token === import45.Storage)) {
            return this._Storage_75;
        }
        if ((token === import46.CacheService)) {
            return this._CacheService_76;
        }
        if ((token === import47.LocalStorage)) {
            return this._LocalStorage_77;
        }
        if ((token === import48.LocalData)) {
            return this._LocalData_78;
        }
        if ((token === import49.Calendar)) {
            return this._Calendar_79;
        }
        if ((token === import50.Network)) {
            return this._Network_80;
        }
        if ((token === import99.TRANSLATIONS_FORMAT)) {
